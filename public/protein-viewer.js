...
class ProteinViewer {
  constructor(containerId) {
    ...
    if (typeof THREE === 'undefined') {
      ...
      this.container.innerHTML = '<div class="loading">3D library not loaded. Please refresh the page.</div>';
      return;
    }
  ...
  async loadProteinStructure(pdbData, medicationName) {
    console.log('Loading protein structure for:', medicationName);
    ...
    // For mock data, create a simple demo structure
    if (pdbData === 'MOCK_PDB_DATA') {
      console.log('Using mock protein structure');
    ...
    try {
      ...
      // Add drug binding site highlight
      this.highlightBindingSite();
